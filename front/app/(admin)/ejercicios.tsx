...
const styles = StyleSheet.create({
  ...
  subtitulo: {fontSize: 14,color: Colors.muted, fontFamily: 'Inter_400Regular'},
  ...
  ejercicioNombre: { fontSize: 14, fontWeight: '600', color: Colors.text, marginBottom: 4, fontFamily: 'Inter_600SemiBold' },
  ...
  btnPrimaryText: { color: Colors.black,fontWeight: 'bold', fontFamily: 'Inter_700Bold'},
