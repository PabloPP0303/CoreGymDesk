...
const styles = StyleSheet.create({
  ...
  subtitulo: { fontSize: 12, color: Colors.red, marginTop: 2, fontFamily: 'Inter_400Regular'},
  ...
  usuarioNombre: { fontSize: 13, fontWeight: '600', color: Colors.text, fontFamily: 'Inter_600SemiBold' },
  usuarioMeta: { fontSize: 11, color: Colors.muted, fontFamily: 'Inter_400Regular' },
  ...
  claseNombre: { fontSize: 13, fontWeight: '600', color: Colors.text, fontFamily: 'Inter_600SemiBold' },
  claseMeta: { fontSize: 11, color: Colors.muted, marginTop: 2,fontFamily: 'Inter_400Regular' },
  ...
  subtituloGimnasio: {fontSize: 14,color: Colors.red,marginTop: 2, fontFamily: 'Inter_400Regular'},
