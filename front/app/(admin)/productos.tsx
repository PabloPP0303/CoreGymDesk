...
const styles = StyleSheet.create({
  ...
  productoInfo: { flex: 1 },
  productoNombre: { fontSize: 14, fontWeight: '600', color: Colors.text, marginBottom: 2, fontFamily: 'Inter_600SemiBold' },
  productoMeta: { fontSize: 12, color: Colors.muted, marginBottom: 6, fontFamily: 'Inter_400Regular' },
  ...
  catText: { fontSize: 12, color: Colors.muted , fontFamily: 'Inter_400Regular'},
  catTextActive: { color: Colors.black, fontWeight: '700', fontFamily: 'Inter_700Bold' },
