...
const styles = StyleSheet.create({
  ...
  claseInfo: { flex: 1 },
  claseNombre: { fontSize: 14, fontWeight: '700', color: Colors.text, marginBottom: 2, fontFamily: 'Inter_600SemiBold' },
  claseMeta: { fontSize: 12, color: Colors.muted, marginBottom: 1, fontFamily: 'Inter_400Regular' },
  ...
  diaText: { fontSize: 12, color: Colors.muted, fontFamily: 'Inter_400Regular' },
  diaTextActive: { color: Colors.black, fontWeight: '700', fontFamily: 'Inter_700Bold' },
  ...
  btnPrimaryText: {color: Colors.black,fontWeight: 'bold', textAlign: 'center',fontSize: 14, fontFamily: 'Inter_700Bold'},
