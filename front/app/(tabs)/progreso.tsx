...
const styles = StyleSheet.create({
  ...
  titulo: { fontSize: 26, fontWeight: '700', color: Colors.text, fontFamily: 'Inter_700Bold' },
  subtitulo: { fontSize: 13, color: Colors.muted, marginTop: 2, fontFamily: 'Inter_400Regular' },
  statsRow: { flexDirection: 'row', gap: 10, padding: 16 },
  statCard: { flex: 1, backgroundColor: Colors.card, borderRadius: 10, padding: 12, borderWidth: 1, borderColor: Colors.border },
  statNum: { fontSize: 22, fontWeight: '700', color: Colors.text, fontFamily: 'Inter_700Bold' },
  statLabel: { fontSize: 11, color: Colors.muted, marginTop: 4, fontFamily: 'Inter_400Regular' },
  statDelta: { fontSize: 11, marginTop: 4, fontWeight: '600', fontFamily: 'Inter_600SemiBold' },
  ...
  marcaNombre: { fontSize: 13, color: Colors.text, fontWeight: '500', fontFamily: 'Inter_600SemiBold' },
