...
const styles = StyleSheet.create({
  ...
  reservaInfo: { flex: 1 },
  reservaNombre: { fontSize: 14, fontWeight: '600', color: Colors.text, marginBottom: 2, fontFamily: 'Inter_600SemiBold' },
  reservaMeta: { fontSize: 12, color: Colors.muted, marginBottom: 1, fontFamily: 'Inter_400Regular' },
