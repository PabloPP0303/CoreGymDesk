...
const styles = StyleSheet.create({
  ...
  filtroBadge: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20, borderWidth: 1, borderColor: Colors.border, marginRight: 8 },
  ...
  productoNombre: { fontSize: 13, fontWeight: '600', color: Colors.text, marginBottom: 2 },
  productoCategoria: { fontSize: 11, color: Colors.muted, marginBottom: 6 },
  productoPrecio: { fontSize: 22, fontWeight: '700', color: Colors.accent, marginBottom: 6 },
  ...
  modalTitulo: { fontSize: 20, fontWeight: '700', color: Colors.text, marginBottom: 4 },
  ...
  modalPrecio: { fontSize: 28, fontWeight: '700', color: Colors.accent },
