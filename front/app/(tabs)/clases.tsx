...
const styles = StyleSheet.create({
  ...
  diaNombre: { fontSize: 11, color: Colors.muted, textAlign: 'center', textTransform: 'uppercase', fontFamily: 'Inter_600SemiBold' },
  ...
  calClaseText: { fontSize: 9, color: Colors.accent, fontFamily: 'Inter_400Regular' },
  section: { padding: 16 },
  ...
  claseNombre: { fontSize: 15, fontWeight: '600', color: Colors.text, marginBottom: 2, fontFamily: 'Inter_600SemiBold' },
  claseMeta: { fontSize: 12, color: Colors.muted, marginBottom: 2, fontFamily: 'Inter_400Regular' },
  ...
  btnDisabledText: { color: Colors.red, fontWeight: '700', fontSize: 14, fontFamily: 'Inter_700Bold' },
