...
const styles = StyleSheet.create({
  ...
  nombre: { fontSize: 22, fontWeight: '700', color: Colors.text, fontFamily: 'Inter_600SemiBold' },
  ...
  label: { fontSize: 12, color: Colors.muted, marginBottom: 5, fontFamily: 'Inter_400Regular' },
  input: { backgroundColor: Colors.dark, borderWidth: 1, borderColor: Colors.border, borderRadius: 8, padding: 10, color: Colors.text, fontSize: 14, fontFamily: 'Inter_400Regular' },
