...
const styles = StyleSheet.create({
  ...
  rutinaNombre: { fontSize: 15, fontWeight: '700', color: Colors.text, flex: 1, fontFamily: 'Inter_600SemiBold' },
  ...
  diaNombre: { fontSize: 11, color: Colors.accent, fontWeight: '700', textTransform: 'uppercase', marginBottom: 6, letterSpacing: 0.5, fontFamily: 'Inter_600SemiBold' },
  ...
  ejercicioNombre: { fontSize: 13, color: Colors.text, fontWeight: '500', fontFamily: 'Inter_600SemiBold' },
  ...
  btnPrimaryText: {color: Colors.black,fontWeight: 'bold', fontSize: 14, fontFamily: 'Inter_700Bold'},  
