...
const styles = StyleSheet.create({
  ...
  statNum: { fontSize: 28, fontWeight: '700', color: Colors.text, fontFamily: 'Inter_700Bold' },
  ...
  sectionTitle: { fontSize: 16, fontWeight: 'bold', color: Colors.text, marginBottom: 12, fontFamily: 'Inter_600SemiBold' },  
  verTodas: { fontSize: 12, color: Colors.accent },
  emptyCard: { backgroundColor: Colors.card, borderRadius: 12, padding: 20, alignItems: 'center', borderWidth: 1, borderColor: Colors.border, fontFamily: 'Inter_600SemiBold'},
  ...
  reservaNombre: { fontSize: 14, fontWeight: '600', color: Colors.text, fontFamily: 'Inter_600SemiBold' },
  reservaMeta: { fontSize: 11, color: Colors.muted, marginTop: 2, fontFamily: 'Inter_400Regular' },
  ...
  quickBtnText: { color: Colors.text, fontWeight: '600', fontSize: 15, fontFamily: 'Inter_600SemiBold' },  
  ...
  btnSalirText: {color: Colors.muted, fontSize: 15, fontFamily: 'Inter_400Regular'},
  titulo: {fontSize: 24,fontWeight: 'bold',color: Colors.text, fontFamily: 'Inter_700Bold'},
  subtitulo: {fontSize: 14,color: Colors.muted, marginTop: 2, fontFamily: 'Inter_400Regular'},
});